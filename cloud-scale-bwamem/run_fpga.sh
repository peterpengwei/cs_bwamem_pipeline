...
-oChoice 2 -oPath hdfs://ubuntu.pengwei.m6.cdsc-local:9000/user/pengwei/null_fpga -localRef 1 -R "@RG	ID:HCC1954	LB:HCC1954	SM:HCC1954" -isSWExtBatched 1 -bSWExtSize 4096 -FPGAAccSWExt $2 -FPGASWExtThreshold 64 \
