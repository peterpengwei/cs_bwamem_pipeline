...
/curr/pengwei/cluster_app/demo_main/run/cloud-scale-bwamem/target/cloud-scale-bwamem-0.2.2-assembly.jar \
cs-bwamem -bfn 1 -bPSW 1 -sbatch 10 -bPSWJNI 1 -jniPath /curr/ytchen0323/shared_lib/jniNative.so \
-oChoice 2 -oPath hdfs://ubuntu.pengwei.m6.cdsc-local:9000/user/pengwei/null_cpu -localRef 1 -R "@RG	ID:HCC1954	LB:HCC1954	SM:HCC1954" -isSWExtBatched 1 -bSWExtSize 32768 -FPGAAccSWExt $2 -FPGASWExtThreshold 64 \
